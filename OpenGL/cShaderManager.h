...
public:
	...
	bool createProgramFromFile(std::string friendlyName, cShader &vertexShad, cShader &geomShad, cShader &fragShader);

	bool createProgramFromSource(std::string friendlyName, cShader &vertexShad, cShader &fragShader);

	bool createProgramFromSource(std::string friendlyName, cShader &vertexShad, cShader &geomShad, cShader &fragShader);
